    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="{{route('admin-companyregistrations.index')}}">Company Deed registrations</a>
                </li>
                <li>
                    <a href="{{route('admin-prazregistrations.index')}}">PRAZ registrations</a>
                </li>
                <li>
                    <a href="{{route('admin-vendorregistrations.index')}}">Vendor registrations</a>
                </li>
                <li>
                    <a href="{{route('directory.index')}}">Directory Listing</a>
                </li>
                <li>
                    <a href="{{route('admin-notices.index')}}">RFQs & Tenders</a>
                </li>
