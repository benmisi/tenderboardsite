...
use App\Http\Controllers\bidbondController;
...
Route::get('/view-notice/{uuid}',[AppProcurementnoticeController::class,'show'])->name('show-notice')->middleware('checsubscription');
...
Route::resource('/bidbonds',bidbondController::class);
