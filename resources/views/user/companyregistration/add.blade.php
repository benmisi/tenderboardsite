 ...
 <form method="POST" action="{{ route('Company-service.store') }}">
  ...
  <div class="card">
    ...
    <div class="row">
     ...
     <x-forms.input  name="corebusiness" label="Core Business" type="text" size="col-md-6"/>
     <x-forms.select  name="companytype" label="Type" :optionlist="$companytypes" size="col-md-6"/>
    </div>
